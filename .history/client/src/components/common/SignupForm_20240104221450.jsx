          ...
          <Box component={"form"} onSubmit={signupForm.handleSubmit} >
               <Stack spacing={3}>
                    ...
                    <TextField type='text' placeholder='Enter your display name' name='displayName'
                         fullWidth value={signupForm.values.displayName} onChange={signupForm.handleChange} color='success'
                         error={signupForm.touched.displayName && signupForm.errors.username !== undefined}
                         helperText={signupForm.touched.displayName && signupForm.errors.username}
                    >
                    </TextField>
