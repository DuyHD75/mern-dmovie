                                             ...
                                             <Stack direction={"row"} spacing={1} alignItems={"center"}>
                                                  ...
                                                  <Divider orientation="vertical" >
                                                       {[...movie.genre_ids].splice(0, 2).map((genreId, index) => (
                                                            <Chip sx={{ marginRight: '10px' }} variant="filled" color="primary" key={index} label={genre.find(e => e.id === genreId) && genre.find(e => e.id === genreId).name}></Chip>
                                                       ))}
                                                  </Divider>
                                             </Stack>
                                             <Typography sx={{ ...uiConfigs.style.typoLines(3) }} variant="body1">{movie.overview}</Typography>
                                             <Button
                                                  variant="contained"
                                                  size="large"
