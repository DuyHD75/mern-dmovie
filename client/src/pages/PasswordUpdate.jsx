...
const PasswordUpdate = () => {
  ...
  const form = useFormik({
    ...
    validationSchema: Yup.object({
      ...
      confirmNewPassword: Yup.string()
        .oneOf([Yup.ref("newPassword")], "Confirm password dose not match !")
  ...
  return (
    <Box sx={{ ...uiConfigs.style.mainContent, display: "flex", margin:"auto" }}  >
      <Container header="update password">
        <Box component="form" minWidth="400px" onSubmit={form.handleSubmit} >
          <Stack spacing={2}>
            <TextField
              type="password"
